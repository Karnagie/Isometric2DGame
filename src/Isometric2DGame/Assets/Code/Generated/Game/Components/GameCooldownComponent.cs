...
public partial class GameEntity {
    ...
    public Code.Core.Features.Cooldowns.Cooldown cooldown { get { return (Code.Core.Features.Cooldowns.Cooldown)GetComponent(GameComponentsLookup.Cooldown); } }
    ...
    public GameEntity AddCooldown(float newValue) {
        ...
        var component = (Code.Core.Features.Cooldowns.Cooldown)CreateComponent(index, typeof(Code.Core.Features.Cooldowns.Cooldown));
