...
public partial class GameEntity {
    ...
    public Code.Core.Features.Cooldowns.CooldownLeft cooldownLeft { get { return (Code.Core.Features.Cooldowns.CooldownLeft)GetComponent(GameComponentsLookup.CooldownLeft); } }
    ...
    public GameEntity AddCooldownLeft(float newValue) {
        ...
        var component = (Code.Core.Features.Cooldowns.CooldownLeft)CreateComponent(index, typeof(Code.Core.Features.Cooldowns.CooldownLeft));
