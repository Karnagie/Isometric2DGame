...
public partial class GameEntity {
    ...
    public Code.Core.Features.Lifetime.CurrentHp currentHp { get { return (Code.Core.Features.Lifetime.CurrentHp)GetComponent(GameComponentsLookup.CurrentHp); } }
    ...
    public GameEntity AddCurrentHp(float newValue) {
        ...
        var component = (Code.Core.Features.Lifetime.CurrentHp)CreateComponent(index, typeof(Code.Core.Features.Lifetime.CurrentHp));
