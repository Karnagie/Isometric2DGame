...
public partial class GameEntity {
    ...
    public Code.Core.Features.Processes.Damage damage { get { return (Code.Core.Features.Processes.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Code.Core.Features.Processes.Damage)CreateComponent(index, typeof(Code.Core.Features.Processes.Damage));
