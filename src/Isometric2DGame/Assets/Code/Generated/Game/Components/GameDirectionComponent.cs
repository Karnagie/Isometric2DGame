...
public partial class GameEntity {
    ...
    public Code.Core.Features.Movement.Direction direction { get { return (Code.Core.Features.Movement.Direction)GetComponent(GameComponentsLookup.Direction); } }
    ...
    public GameEntity AddDirection(UnityEngine.Vector2 newValue) {
        ...
        var component = (Code.Core.Features.Movement.Direction)CreateComponent(index, typeof(Code.Core.Features.Movement.Direction));
