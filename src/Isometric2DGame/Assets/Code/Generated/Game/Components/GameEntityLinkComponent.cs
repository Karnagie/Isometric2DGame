...
public partial class GameEntity {
    ...
    public Code.Core.Common.EntityLink entityLink { get { return (Code.Core.Common.EntityLink)GetComponent(GameComponentsLookup.EntityLink); } }
    ...
    public GameEntity AddEntityLink(int newValue) {
        ...
        var component = (Code.Core.Common.EntityLink)CreateComponent(index, typeof(Code.Core.Common.EntityLink));
