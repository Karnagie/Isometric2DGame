...
public partial class GameEntity {
    ...
    public Code.Core.Common.Id id { get { return (Code.Core.Common.Id)GetComponent(GameComponentsLookup.Id); } }
    ...
    public GameEntity AddId(int newValue) {
        ...
        var component = (Code.Core.Common.Id)CreateComponent(index, typeof(Code.Core.Common.Id));
