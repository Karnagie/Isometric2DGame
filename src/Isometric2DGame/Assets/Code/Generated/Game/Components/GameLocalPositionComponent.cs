...
public partial class GameEntity {
    ...
    public Code.Core.Common.LocalPosition localPosition { get { return (Code.Core.Common.LocalPosition)GetComponent(GameComponentsLookup.LocalPosition); } }
    ...
    public GameEntity AddLocalPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.Core.Common.LocalPosition)CreateComponent(index, typeof(Code.Core.Common.LocalPosition));
