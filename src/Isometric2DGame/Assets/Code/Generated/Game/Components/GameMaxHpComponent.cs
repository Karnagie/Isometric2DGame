...
public partial class GameEntity {
    ...
    public Code.Core.Features.Lifetime.MaxHp maxHp { get { return (Code.Core.Features.Lifetime.MaxHp)GetComponent(GameComponentsLookup.MaxHp); } }
    ...
    public GameEntity AddMaxHp(float newValue) {
        ...
        var component = (Code.Core.Features.Lifetime.MaxHp)CreateComponent(index, typeof(Code.Core.Features.Lifetime.MaxHp));
