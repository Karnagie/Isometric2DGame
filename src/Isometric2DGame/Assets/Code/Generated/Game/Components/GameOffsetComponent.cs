...
public partial class GameEntity {
    ...
    public Code.Core.Features.Movement.Offset offset { get { return (Code.Core.Features.Movement.Offset)GetComponent(GameComponentsLookup.Offset); } }
    ...
    public GameEntity AddOffset(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.Core.Features.Movement.Offset)CreateComponent(index, typeof(Code.Core.Features.Movement.Offset));
