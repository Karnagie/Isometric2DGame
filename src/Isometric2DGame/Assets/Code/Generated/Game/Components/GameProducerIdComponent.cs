...
public partial class GameEntity {
    ...
    public Code.Core.Features.Processes.ProducerId producerId { get { return (Code.Core.Features.Processes.ProducerId)GetComponent(GameComponentsLookup.ProducerId); } }
    ...
    public GameEntity AddProducerId(int newValue) {
        ...
        var component = (Code.Core.Features.Processes.ProducerId)CreateComponent(index, typeof(Code.Core.Features.Processes.ProducerId));
