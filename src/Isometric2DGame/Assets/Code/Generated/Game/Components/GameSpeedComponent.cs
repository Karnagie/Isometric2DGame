...
public partial class GameEntity {
    ...
    public Code.Core.Features.Movement.Speed speed { get { return (Code.Core.Features.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Code.Core.Features.Movement.Speed)CreateComponent(index, typeof(Code.Core.Features.Movement.Speed));
