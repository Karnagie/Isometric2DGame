...
public partial class GameEntity {
    ...
    public Code.Core.Common.SpriteRendererComponent spriteRenderer { get { return (Code.Core.Common.SpriteRendererComponent)GetComponent(GameComponentsLookup.SpriteRenderer); } }
    ...
    public GameEntity AddSpriteRenderer(UnityEngine.SpriteRenderer newValue) {
        ...
        var component = (Code.Core.Common.SpriteRendererComponent)CreateComponent(index, typeof(Code.Core.Common.SpriteRendererComponent));
