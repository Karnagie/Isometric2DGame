...
public partial class GameEntity {
    ...
    public Code.Core.Common.TransformComponent transform { get { return (Code.Core.Common.TransformComponent)GetComponent(GameComponentsLookup.Transform); } }
    ...
    public GameEntity AddTransform(UnityEngine.Transform newValue) {
        ...
        var component = (Code.Core.Common.TransformComponent)CreateComponent(index, typeof(Code.Core.Common.TransformComponent));
