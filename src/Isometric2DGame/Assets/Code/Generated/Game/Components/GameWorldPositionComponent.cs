...
public partial class GameEntity {
    ...
    public Code.Core.Common.WorldPosition worldPosition { get { return (Code.Core.Common.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.Core.Common.WorldPosition)CreateComponent(index, typeof(Code.Core.Common.WorldPosition));
