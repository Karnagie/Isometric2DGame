...
public partial class InputEntity {
    ...
    public Code.Core.Input.MoveInput moveInput { get { return (Code.Core.Input.MoveInput)GetComponent(InputComponentsLookup.MoveInput); } }
    ...
    public InputEntity AddMoveInput(UnityEngine.Vector2 newValue) {
        ...
        var component = (Code.Core.Input.MoveInput)CreateComponent(index, typeof(Code.Core.Input.MoveInput));
